...
public class CLIArguments {
    ...
    @Parameter(
            ...
            validateWith = CLIKeywordValidator.class, // Validar que este correctamente los comandos
            description = "KEYWORD"
    )
    ...
    @Parameter(
            names = "--help",
            help = true,
            validateWith = CLIHelpValidator.class, // Revisa lo que tiene que hacer el validator
